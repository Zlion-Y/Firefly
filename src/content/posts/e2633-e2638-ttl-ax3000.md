...
连接好后，使用 MobaXterm 等软件新建串口连接，波特率设置为 `115200`。

路由器上电后马上按 `1` 中断系统启动，输入密码进入 u-boot（密码来自[这里](https://voz.vn/t/unlock-mesh-zte-e1600-2603-2615-thanh-phien-ban-quoc-te.903294/)）：
...
```shell
tftp 0x43000000 e2631\\\_no\\\_oob\\\_full\\\_128MiB.bin
```
